...
- Utilizar Mailtrap pra testar envios em ambiente de desenvolvimento;
...
- O prestador deve receber um anotificação sempre que houver um novo agendamento;
...
- O usuário deve poder listar horários disponíveis em um dia expecífico de um pretador;
